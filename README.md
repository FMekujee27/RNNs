Recurrent neural network (RNN) has made breakthroughs in time series forecasting. The goal of this project is to see which model performs the best for the
